            ...
            */
            ...
            /**
            *  ModifyHostInfoRequest bean class
            */
    ...
    public static class Factory{
        ...
        */
        public static ModifyHostInfoRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ModifyHostInfoRequest object = new ModifyHostInfoRequest();
            int event;
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    if (!"ModifyHostInfoRequest".equals(type)){
                        //find namespace for the prefix
                        java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                        return (ModifyHostInfoRequest)cn.livedoor.www.sysguard.ExtensionMapper.getTypeObject(
                             nsUri,type,reader);
                      }
