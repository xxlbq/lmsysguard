            ...
            */
            ...
            /**
            *  GetOperationByIdRequest bean class
            */
    ...
    public static class Factory{
        ...
        */
        public static GetOperationByIdRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetOperationByIdRequest object = new GetOperationByIdRequest();
            int event;
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    if (!"GetOperationByIdRequest".equals(type)){
                        //find namespace for the prefix
                        java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                        return (GetOperationByIdRequest)cn.livedoor.www.sysguard.ExtensionMapper.getTypeObject(
                             nsUri,type,reader);
                      }
