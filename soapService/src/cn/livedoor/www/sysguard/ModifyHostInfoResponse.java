            ...
            */
            ...
            /**
            *  ModifyHostInfoResponse bean class
            */
        
        public  class ModifyHostInfoResponse
    ...
    public static class Factory{
        ...
        */
        public static ModifyHostInfoResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ModifyHostInfoResponse object = new ModifyHostInfoResponse();
            int event;
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    if (!"ModifyHostInfoResponse".equals(type)){
                        //find namespace for the prefix
                        java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                        return (ModifyHostInfoResponse)cn.livedoor.www.sysguard.ExtensionMapper.getTypeObject(
                             nsUri,type,reader);
                      }
