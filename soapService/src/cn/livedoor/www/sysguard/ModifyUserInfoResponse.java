            ...
            */
            ...
            /**
            *  ModifyUserInfoResponse bean class
            */
    ...
    public static class Factory{
        ...
        */
        public static ModifyUserInfoResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ModifyUserInfoResponse object = new ModifyUserInfoResponse();
            int event;
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    if (!"ModifyUserInfoResponse".equals(type)){
                        //find namespace for the prefix
                        java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                        return (ModifyUserInfoResponse)cn.livedoor.www.sysguard.ExtensionMapper.getTypeObject(
                             nsUri,type,reader);
                      }
